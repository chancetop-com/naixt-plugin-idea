...
public class WebServiceClientBuilder<T> {
    ...
    public WebServiceClientBuilder(Class<T> serviceInterface, WebServiceClient client, String... classpath) {
        this.serviceInterface = serviceInterface;
        this.client = client;
        builder = new DynamicInstanceBuilder<>(serviceInterface, "Client", classpath);
    }
