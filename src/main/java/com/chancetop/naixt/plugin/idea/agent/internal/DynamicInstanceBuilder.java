 ...
 * @author neo
 * caution:
 * copy from core-ng framework, used to generate dynamic class, but the framework cannot set the classpath
 * here we must add the PluginClassLoader's classpath to the javassist pool
 */
public class DynamicInstanceBuilder<T> {
    ...
    public DynamicInstanceBuilder(Class<? super T> interfaceClass, String name, String... classpath) {
        classpath(classpath);
